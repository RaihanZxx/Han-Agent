...
def ask_user_for_input(question: str):
    ...
    return json.dumps(
        {"success": True, "data": {"type": "user_input_request", "question": question}}
    )
    ...
    function_declarations=[
        glm.FunctionDeclaration(
            ...
            parameters=glm.Schema(
                type=Type.OBJECT,
                properties={
                    "final_summary": glm.Schema(
                        type=Type.STRING,
                        description="Ringkasan singkat tentang apa yang telah dicapai.",
                    )
                },
        ...
        glm.FunctionDeclaration(
            ...
            parameters=glm.Schema(
                ...
                properties={
                    "question": glm.Schema(
                        type=Type.STRING,
                        description="Pertanyaan yang akan diajukan kepada pengguna.",
                    )
                },
                required=["question"],
            ),
